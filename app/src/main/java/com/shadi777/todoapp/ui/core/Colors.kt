...
val LightBlueTranslucent = Color(0x54007AFF)
val LightGrayExtra = Color(0xFFD1D1D6)
...
val DarkBlueTranslucent = Color(0x540A84FF)
val DarkGrayExtra = Color(0xFF48484A)